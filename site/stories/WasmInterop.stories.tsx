...
import { wasmInteropCase } from '../src/showcase/cases/wasm-interop';
import { makeShowcaseRenderers } from '../src/showcase/files.tsx';

const { model, caseDir } = wasmInteropCase;
const showcase = makeShowcaseRenderers(caseDir);

function WasmInteropDemo() {
  return (
...
const meta = {
  ...
  title: 'WASM/Host guest pipeline',
...
export const HostGuestChecksum: Story = {
  render: () => <WasmInteropDemo />,
};
