...
import { swiftNotesCase } from '../src/showcase/cases/swift-notes';
import { makeShowcaseRenderers } from '../src/showcase/files.tsx';

const { model, caseDir } = swiftNotesCase;
const showcase = makeShowcaseRenderers(caseDir);

function SwiftNotesDemo() {
  return (
...
const meta = {
  ...
  title: 'Swift/SwiftUI notes screen',
...
export const SwiftUINotesScreen: Story = {
  render: () => <SwiftNotesDemo />,
};
