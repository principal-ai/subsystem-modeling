...
import { dbtOrdersCase } from '../src/showcase/cases/dbt-orders';
import { makeShowcaseRenderers } from '../src/showcase/files.tsx';

const { model, caseDir } = dbtOrdersCase;
const showcase = makeShowcaseRenderers(caseDir);

function DbtOrdersDemo() {
  return (
...
export const DbtOrdersModels: Story = {
  render: () => <DbtOrdersDemo />,
};
