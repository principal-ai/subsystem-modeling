...
import { dailyDigestCase } from '../src/showcase/cases/daily-digest';
import { makeShowcaseRenderers } from '../src/showcase/files.tsx';

const { model, caseDir } = dailyDigestCase;
const showcase = makeShowcaseRenderers(caseDir);

function DailyDigestDemo() {
  return (
...
const meta = {
  ...
  title: 'TypeScript/Daily page digest',
...
export const DailyPageDigest: Story = {
  render: () => <DailyDigestDemo />,
};
